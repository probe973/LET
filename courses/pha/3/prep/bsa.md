...
<section class="revision-container" aria-labelledby="revision-heading">
    <div class="revision-header">
        <h2 id="revision-heading">Body Surface Area</h2>
...
<script src="{{ '/assets/js/pha/rqs/bsa.js' | relative_url }}"></script>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (window.initRevisionTest && window.bsaQuestionGenerators) {
            window.initRevisionTest(window.bsaQuestionGenerators);
        } else {

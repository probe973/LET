---
layout: pha
title: Mass, moles, and molarity
---

<section class="revision-container" aria-labelledby="revision-heading">
    <div class="revision-header">
        <h2 id="revision-heading">Mass from molecular mass and molarity</h2>
...
<script src="{{ '/assets/js/pha/rqs/3-moles.js' | relative_url }}"></script>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (window.initRevisionTest && window.molarityQuestionGenerators) {
            window.initRevisionTest(window.molarityQuestionGenerators);
        } else {

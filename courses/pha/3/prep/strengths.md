---
layout: pha
title: Formula Strengths
---

<section class="revision-container" aria-labelledby="revision-heading">
    <div class="revision-header">
        <h2 id="revision-heading">Percentage Formula Strengths</h2>
...
<script src="{{ '/assets/js/pha/rqs/3-strengths.js' | relative_url }}"></script>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (window.initRevisionTest && window.strengthQuestionGenerators) {
            window.initRevisionTest(window.strengthQuestionGenerators);
        } else {

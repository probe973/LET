    ...
    document.addEventListener('DOMContentLoaded', () => {
        if (window.initAlgebraRevisionTest && window.normalGenerators) {
            window.initAlgebraRevisionTest([
                { generator: window.normalGenerators.typeStandardise, count: 3 },
                { generator: window.normalGenerators.typeDeStandardise, count: 3 }

...
<script src="{{ '/assets/js/nbs4107a/probability.js' | relative_url }}"></script>
<script src="{{ '/assets/js/algebra-revision-core.js' | relative_url }}"></script>

<script>
    document.addEventListener('DOMContentLoaded', () => {
        if (window.initAlgebraRevisionTest && window.probabilityGenerators) {
            window.initAlgebraRevisionTest([
                { generator: window.probabilityGenerators.typeCT2x2type1, count: 1 },
                { generator: window.probabilityGenerators.typeCT2x2type2, count: 1 },
                { generator: window.probabilityGenerators.typeCT2x2type3, count: 1 }
